jQuery(document).ready(function($){
	...
	if( cartWrapper.length > 0 ) {
		...
		cartList.on('click', '.delete-item', function(event){
			event.preventDefault();
			removeProduct($(event.target).parents('.productX'));
		});
